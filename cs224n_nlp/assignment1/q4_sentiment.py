...
def getRegularizationValues():
    ...
    """
    values = [1.0e-3, 3.0e-3, 5.0e-3, 7.0e-3, 9.0e-3, 1.0e-4, 3.0e-4, 5.0e-4, 7.0e-4, 9.0e-4, 1.0e-5, 3.0e-5, 5.0e-5,
              7.0e-5, 9.0e-5]  # Assign a list of floats in the block below
    ### YOUR CODE HERE
    ### END YOUR CODE
