...
class SoftmaxModel(Model):
    ...
    def add_prediction_op(self):
        ...
        """
        ### YOUR CODE HERE
        weights = tf.get_variable('weights', shape=(Config.n_features, Config.n_classes),
                                  initializer=tf.zeros_initializer)
        bias = tf.get_variable('bias', shape=(Config.n_classes), initializer=tf.zeros_initializer)
